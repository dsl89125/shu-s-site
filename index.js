  ...
  function milesBiked() {
      var query = new google.visualization.Query(
          'https://docs.google.com/spreadsheets/d/1hthJYxN90sh1FFYSxhAtv9RabRnsP7NQc6PNK-M1DgE/edit?usp=sharing');
  ...
  function handleQueryResponse(response) {
      ...
      // console.log(data.og[latestNum].c[0].f);
      ...
      document.getElementById("lineChart1UpdateDate").innerHTML = "Last Automatic Update : "+ data.og[latestNum].c[0].f ;
  ...
  function coffeeVsTeaPieChartQueryResponse(response) {
      ...
      chart.draw(data, options);
      document.getElementById("coffeeVsTeaPieChartUpdateDate").innerHTML = "Last Automatic Update : "+ data.og[2].c[0].v + ", "+ data.og[3].c[0].v;
  }
  // Coffee VS Tea Pie Chart  
